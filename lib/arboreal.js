!function () {
  ...
  Arboreal.prototype.serialize = function (options) {
    options = options || {};
    var childrenAttr = options.childrenAttr || 'children';

    return (function walkDown(node) {
      var data = node.data,
      ...
      if (len) {
        data[childrenAttr] = [];
        for (i = 0; i < len; i++) {
          data[childrenAttr].push(walkDown(node.children[i]));
        }
      }
  ...
  Arboreal.prototype.length = function () {
